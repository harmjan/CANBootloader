...
\section*{Orientation}
	...
	\subsection*{Tools}
		...
		To work with the UART bootloader they bought cables to communicate between the computer and processor over UART.
		These cables can also be used to send debug information between the computer and the processor.
	...
	\subsection*{Facilties}
		The faculty has a soldering room with most common equipment like breadboards and jumper wires.
		We can use these as we like for making test setups for the node.

\section*{Design}
	After the orientation project we focused on the main problem, the CAN bootloader for the LPC1769.
	...
	\subsection*{Overview LPC1769}
		The memory of the LPC1769 look like \autoref{fig:flash}.
		Our program must reside in the Flash memory with the user program.
		\begin{figure}[htbp]
			\centering
			\begin{bytefield}{24}
	...
	%Tools to program the node's with, how to facilitate the computer  sensor network interface

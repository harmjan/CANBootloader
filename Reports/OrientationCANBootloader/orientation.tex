...
\section*{Design}
	...
	\subsection*{CAN Protocol}
		...
		% Hash from 4 bytes to 11 bits? Unique during compiling? Howto prevent collision with debugging protocol?
		...
		\begin{figure}[h]
			...
			\begin{sequencediagram}
				...
				\begin{sdloop}{Foreach sector}
					\begin{call}{a}{0x102}{b}{} % Send data
					\end{call}
				\end{sdloop}
				\begin{call}{a}{0x103}{b}{} % CRC
				\end{call}
				\begin{call}{a}{0x104}{b}{} % IAP command to copy to flash
				\end{call}

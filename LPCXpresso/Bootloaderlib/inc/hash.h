 ...
 * ===============================================================================================================
 *
 * The function headers to create and check hashes.
 *
...
/** The number of hashes that are generated during every update cycle */
#define HASH_COUNT       4

/** The final amount of hashes (32bit) that will be transmitted */
#define HASH_COUNT_FINAL 2
